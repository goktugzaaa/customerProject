  ...
  return (
    <div className="h-full w-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col px-5 pt-2">
        ...
        >
          <p className="text-3xl font-light text-foreground tabular-nums">20:30</p>
          <p className="text-sm text-muted mt-1">Tuesday 27th August</p>
        </motion.div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="mt-10 flex-1 max-h-[320px] rounded-3xl border border-[var(--surface-border)] bg-[var(--surface)] flex flex-col items-center justify-center px-6"
        >
          <div
          ...
          <p className="text-[13px] text-muted text-center mt-3 leading-relaxed">
